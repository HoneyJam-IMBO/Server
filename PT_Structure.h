...
typedef struct _S_PT_BOSS_FREQUENCY_MOVE_SC
{
	FLOAT POSX;
	FLOAT POSY;
	FLOAT POSZ;
	FLOAT ANGLEY;
	INT ANIMNUM;
} S_PT_BOSS_FREQUENCY_MOVE_SC;

typedef struct _S_PT_BOSS_FREQUENCY_MOVE_CS
{
	FLOAT POSX;
	FLOAT POSY;
	FLOAT POSZ;
...
typedef struct _S_PT_RANGE_SKILL_INFO_CS {
	INT SLOT_ID;
	FLOAT X, Y, Z;
}S_PT_RANGE_SKILL_INFO_CS;
typedef struct _S_PT_RANGE_SKILL_INFO_SC {
	INT SLOT_ID;
	FLOAT X, Y, Z;
}S_PT_RANGE_SKILL_INFO_SC;