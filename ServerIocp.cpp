	...
	if (pConnectedSession->ReadPacketForIocp(dwDataLength))
	{
		...
		while (pConnectedSession->GetPacket(dwProtocol, Packet, dwPacketLength))
		{
			...
			case PT_FREQUENCY_MOVE_CS:
				...
				break;
			case PT_BOSS_FREQUENCY_MOVE_CS:
				PROC_PT_BOSS_FREQUENCY_MOVE_CS(pConnectedSession, dwProtocol, Packet, dwPacketLength);
				break;
			case PT_MOUSE_LEFT_ATTACK_CS:
				PROC_PT_MOUSE_LEFT_ATTACK_CS(pConnectedSession, dwProtocol, Packet, dwPacketLength);
				break;
			case PT_SKILL_COLLISION_TO_TARGET_CS:
				PROC_PT_SKILL_COLLISION_TO_TARGET_CS(pConnectedSession, dwProtocol, Packet, dwPacketLength);
				break;
